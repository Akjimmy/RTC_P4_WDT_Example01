// ======================================================================
// RTC_P4_WDT_Example01.v generated from TopDesign.cysch
// 08/12/2020 at 15:57
...
module SW_Tx_UART_v1_50_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("2d995e91-1666-40ac-9def-5d86ed97599b/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__LED_Alarm_net;
	wire [0:0] tmpFB_0__LED_Alarm_net;
	wire [0:0] tmpIO_0__LED_Alarm_net;
	wire [0:0] tmpINTERRUPT_0__LED_Alarm_net;
	electrical [0:0] tmpSIOVREF__LED_Alarm_net;

	cy_psoc3_pins_v1_10
		#(.id("f978fbe2-2006-41a9-b5b5-4204a3c3c6aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Alarm
		 (.oe(tmpOE__LED_Alarm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Alarm_net[0:0]}),
		  .io({tmpIO_0__LED_Alarm_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Alarm_net),
		  .interrupt({tmpINTERRUPT_0__LED_Alarm_net[0:0]}),
		  .annotation({Net_47}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_Alarm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_WdtIsr_net;
	wire [0:0] tmpFB_0__LED_WdtIsr_net;
	wire [0:0] tmpIO_0__LED_WdtIsr_net;
	wire [0:0] tmpINTERRUPT_0__LED_WdtIsr_net;
	electrical [0:0] tmpSIOVREF__LED_WdtIsr_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3dba336a-f6a5-43fb-aed3-de1e0b7bf362"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_WdtIsr
		 (.oe(tmpOE__LED_WdtIsr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_WdtIsr_net[0:0]}),
		  .io({tmpIO_0__LED_WdtIsr_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_WdtIsr_net),
		  .interrupt({tmpINTERRUPT_0__LED_WdtIsr_net[0:0]}),
		  .annotation({Net_1782}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_WdtIsr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LFCLK_Out_net;
	wire [0:0] tmpFB_0__LFCLK_Out_net;
	wire [0:0] tmpIO_0__LFCLK_Out_net;
	wire [0:0] tmpINTERRUPT_0__LFCLK_Out_net;
	electrical [0:0] tmpSIOVREF__LFCLK_Out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LFCLK_Out
		 (.oe(tmpOE__LFCLK_Out_net),
		  .y({Net_179}),
		  .fb({tmpFB_0__LFCLK_Out_net[0:0]}),
		  .io({tmpIO_0__LFCLK_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__LFCLK_Out_net),
		  .interrupt({tmpINTERRUPT_0__LFCLK_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LFCLK_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
